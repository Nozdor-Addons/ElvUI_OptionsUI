...
local function GetOptionsTable_Power(hasDetatchOption, updateFunc, groupName, numUnits, hasStrataLevel)
    ...
    E.db.unitframe.units[groupName].power = E.db.unitframe.units[groupName].power or {}
...
local function GetOptionsTable_Cutaway(updateFunc, groupName, numGroup)
	...
	if unit then
		unit.cutaway = unit.cutaway or {}
		unit.cutaway.health = unit.cutaway.health or {}
		unit.cutaway.power = unit.cutaway.power or {}
	end
	local config = {
		order = 1021,
		type = "group",
...
E.Options.args.unitframe.args.raid10 = {
	...
	args = {
		...
		resetSettings = {
			...
			type = "execute",
			name = L["Restore Defaults"],
			func = function(info) E:StaticPopup_Show("RESET_UF_UNIT", L["Raid-10"], nil, {unit="raid10", mover="Raid 10 Frames"}) end
		},
		copyFrom = {
			order = 4,
			type = "select",
		...
		healPredction = GetOptionsTable_HealPrediction(UF.CreateAndUpdateHeaderGroup, "raid10"),
		...
		roleIcon = {
			...
			type = "group",
			name = L["Role Icon"],
			get = function(info) return E.db.unitframe.units.raid10.roleIcon[info[#info]] end,
			set = function(info, value) E.db.unitframe.units.raid10.roleIcon[info[#info]] = value UF:CreateAndUpdateHeaderGroup("raid10") end,
			args = {
				header = {
					order = 1,
					type = "header",
...
E.Options.args.unitframe.args.raid25 = {
	...
	args = {
		...
		resetSettings = {
			...
			type = "execute",
			name = L["Restore Defaults"],
			func = function(info) E:StaticPopup_Show("RESET_UF_UNIT", L["Raid-25"], nil, {unit="raid25", mover="Raid 25 Frames"}) end
		},
		copyFrom = {
			order = 4,
			type = "select",
		...
		healPredction = GetOptionsTable_HealPrediction(UF.CreateAndUpdateHeaderGroup, "raid25"),
		...
		roleIcon = {
			...
			type = "group",
			name = L["Role Icon"],
			get = function(info) return E.db.unitframe.units.raid25.roleIcon[info[#info]] end,
			set = function(info, value) E.db.unitframe.units.raid25.roleIcon[info[#info]] = value UF:CreateAndUpdateHeaderGroup("raid25") end,
			args = {
				header = {
					order = 1,
					type = "header",
