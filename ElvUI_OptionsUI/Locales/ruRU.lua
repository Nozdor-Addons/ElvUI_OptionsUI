...
L["Select what the System datatext shows on the panel."] = "Выберите, что инфо-текст системы показывает на панели."
L["Select what the System datatext tooltip shows by default. Hold Shift to show the opposite list."] = "Выберите, что подсказка инфо-текста системы показывает по умолчанию. Зажмите Shift, чтобы показать противоположный список."
...
L["Style"] = "Стиль"
L["System Display"] = "Отображение системы"
L["System Tooltip Display"] = "Отображение подсказки системы"
...
L["YELL"] = "Крик"
L["Show Bubbles"] = "Показать разделения"
L["Quest XP"] = "Опыт за квесты"
L["Quest XP Color"] = "Цвет опыта"
L["Add Quest XP to Tooltip"] = "Квесты текущей зоны в подсказке"
L["Quests in Current Zone Only"] = "Квесты только этой зоны"
L["Completed Quests Only"] = "Только выполненные квесты"
L["Add Quest XP to Tooltip"] = "Добавить опыт в подсказку"
L["Transparent Backdrops"] = "Прозрачный фон"
L["Transparent Buttons"] = "Прозрачные кнопки"
L["World State Frame"] = "Мировой фрейм"
L["Miscellaneous"] = "Разное"
