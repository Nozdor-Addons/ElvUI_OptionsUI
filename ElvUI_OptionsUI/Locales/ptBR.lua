...
L["Select what the System datatext shows on the panel."] = "Selecione o que o texto informativo do sistema mostra no painel."
L["Select what the System datatext tooltip shows by default. Hold Shift to show the opposite list."] = "Selecione o que a dica do texto informativo do sistema mostra por padrão. Segure Shift para mostrar a lista oposta."
...
L["Style Filter"] = true
L["Style"] = "Estilo"
L["System Display"] = "Exibição do sistema"
L["System Tooltip Display"] = "Exibição da dica do sistema"
L["TALENTS"] = "Talentos"
