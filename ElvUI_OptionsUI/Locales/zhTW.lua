...
L["Select what the System datatext shows on the panel."] = "選擇系統資訊文字在面板上顯示的內容。"
L["Select what the System datatext tooltip shows by default. Hold Shift to show the opposite list."] = "選擇系統資訊文字提示預設顯示的內容。按住 Shift 顯示相反列表。"
...
L["Style"] = "風格"
L["System Display"] = "系統顯示"
L["System Tooltip Display"] = "系統提示顯示"
