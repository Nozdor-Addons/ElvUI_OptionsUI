...
L["Select what the System datatext shows on the panel."] = "패널에 표시할 시스템 정보 문자를 선택합니다."
L["Select what the System datatext tooltip shows by default. Hold Shift to show the opposite list."] = "시스템 정보 문자 툴팁에 기본으로 표시할 항목을 선택합니다. Shift 키를 누르면 반대 목록을 표시합니다."
...
L["Style"] = "디자인"
L["System Display"] = "시스템 표시"
L["System Tooltip Display"] = "시스템 툴팁 표시"
