...
L["Select what the System datatext shows on the panel."] = true
L["Select what the System datatext tooltip shows by default. Hold Shift to show the opposite list."] = true
...
L["Style Filter"] = true
L["Style"] = true
L["System Display"] = true
L["System Tooltip Display"] = true
