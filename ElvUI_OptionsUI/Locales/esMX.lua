...
L["Select what the System datatext shows on the panel."] = "Selecciona lo que el texto informativo del sistema muestra en el panel."
L["Select what the System datatext tooltip shows by default. Hold Shift to show the opposite list."] = "Selecciona lo que la descripción del texto informativo del sistema muestra por defecto. Mantén Shift para mostrar la lista opuesta."
...
L["Style Filter"] = true
L["Style"] = "Estilo"
L["System Display"] = "Visualización del sistema"
L["System Tooltip Display"] = "Visualización de la descripción del sistema"
