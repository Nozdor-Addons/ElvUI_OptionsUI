...
L["Select what the System datatext shows on the panel."] = "选择系统信息文字在面板上显示的内容。"
L["Select what the System datatext tooltip shows by default. Hold Shift to show the opposite list."] = "选择系统信息文字提示默认显示的内容。按住 Shift 显示相反列表。"
...
L["Style"] = "风格"
L["System Display"] = "系统显示"
L["System Tooltip Display"] = "系统提示显示"
